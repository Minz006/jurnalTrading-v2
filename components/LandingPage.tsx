...
export const LandingPage: React.FC<LandingPageProps> = ({ onNavigate }) => {
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-black text-slate-800 dark:text-zinc-200 flex flex-col font-sans selection:bg-primary selection:text-white overflow-hidden relative">
      ...
      {/* Navbar Responsive */}
      <nav className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 py-4 sm:py-6">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 sm:gap-0">
          ...
          <div className="flex items-center space-x-2 w-full sm:w-auto justify-center sm:justify-start">
            ...
            <span className="text-xl sm:text-2xl font-bold tracking-tight">jurnalTrading</span>
          </div>
          ...
          <div className="flex items-center gap-3 w-full sm:w-auto justify-center sm:justify-end">
            <button 
              ...
              className="text-sm font-semibold text-slate-600 dark:text-zinc-400 hover:text-primary dark:hover:text-white transition-colors px-2"
            >
              Masuk
            </button>
            <button 
      ...
      {/* Hero Section */}
      <main className="relative z-10 flex-1 flex flex-col items-center text-center px-4 sm:px-6 lg:px-8 mt-6 sm:mt-10 mb-20">
        <div className="animate-fade-in-up max-w-4xl mx-auto">
          <div className="inline-flex items-center space-x-2 bg-blue-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-900/50 rounded-full px-3 py-1 mb-6 sm:mb-8">
            <span className="flex h-2 w-2 rounded-full bg-blue-500 animate-pulse"></span>
            <span className="text-[10px] sm:text-xs font-semibold text-blue-700 dark:text-blue-300 tracking-wide uppercase">Platform Jurnal #1</span>
          </div>
          
          <h1 className="text-4xl sm:text-5xl md:text-7xl font-extrabold tracking-tight mb-6 leading-tight text-slate-900 dark:text-white">
            Catat. Analisa. <br />
          ...
          <p className="text-base sm:text-lg md:text-xl text-slate-600 dark:text-zinc-400 mb-8 sm:mb-10 max-w-2xl mx-auto leading-relaxed">
        ...
        {/* Feature Highlights */}
        <div className="mt-16 sm:mt-24 grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 max-w-6xl w-full animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
          <FeatureCard 
            icon={BarChart3} 
        ...
        <div className="mt-20 sm:mt-32 w-full max-w-5xl animate-fade-in-up px-2 sm:px-0" style={{ animationDelay: '0.4s' }}>
          <div className="relative rounded-3xl overflow-hidden bg-slate-900 dark:bg-zinc-900 text-white shadow-2xl">
            ...
            <div className="relative z-10 p-6 sm:p-12 flex flex-col md:flex-row items-center justify-between gap-8">
              <div className="flex-1 text-left">
                ...
                <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4">Apakah Psikologi Trading Anda Sudah Matang?</h2>
                ...
                <button 
                  ...
                  className="w-full sm:w-auto px-8 py-3 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 rounded-xl font-bold text-white shadow-lg shadow-purple-500/30 transition-all transform hover:scale-105"
                >
              ...
              <div className="flex-1 flex justify-center">
                 {/* Visual Illustration */}
                 <div className="w-48 h-48 sm:w-64 sm:h-64 bg-gradient-to-br from-slate-800 to-black rounded-full border-4 border-slate-700/50 flex items-center justify-center relative shadow-2xl">
                    <div className="absolute inset-2 border-2 border-dashed border-slate-600/50 rounded-full animate-spin-slow"></div>
                    <Brain className="w-16 h-16 sm:w-24 sm:h-24 text-purple-400 drop-shadow-[0_0_15px_rgba(168,85,247,0.5)]" />
                 </div>
              </div>
            </div>
          </div>
