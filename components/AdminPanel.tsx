...
import { Shield, Trash2, RefreshCw, LogOut, Loader2, CheckCircle, AlertTriangle } from 'lucide-react';
...
export const AdminPanel: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-100 dark:bg-slate-900 text-slate-800 dark:text-slate-200">
      <header className="bg-white dark:bg-slate-800 border-b border-gray-200 dark:border-slate-700 p-4">
      ...
      <main className="max-w-6xl mx-auto p-4 md:p-8">
        <div className="flex justify-between items-center mb-6">
          ...
          <button onClick={() => fetchUsers(token)} className="p-2 bg-white dark:bg-slate-800 rounded-lg border dark:border-slate-700 hover:bg-gray-50">
        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm overflow-hidden border border-gray-200 dark:border-slate-700">
          <div className="overflow-x-auto">
            <table className="w-full text-left text-sm">
              <thead className="bg-gray-50 dark:bg-slate-900/50 text-slate-500 uppercase font-bold text-xs">
                <tr>
              ...
              <tbody className="divide-y divide-gray-100 dark:divide-slate-700">
                {users.map(u => (
                  <tr key={u.id} className="hover:bg-gray-50 dark:hover:bg-slate-700/30">
                    ...
                    <td className="p-4 font-mono">${parseFloat(u.initial_balance).toLocaleString()}</td>
